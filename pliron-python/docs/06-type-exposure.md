...
```python
i32 = pliron.IntegerType.get(32)     # Py<IntegerType>
i32.get_width()                       # concrete accessor -> 32
i32.to_type().type_name()             # project, then a generic op
maybe = pliron.IntegerType.from_type(i32.to_type())   # -> IntegerType | None
```
...
that take "any type" (`FunctionType.get`, `IRBuilder.create_block`,
