...
use ::pliron::{
    ...
    irbuild::{
        ...
        rewriter::{IRRewriter, Rewriter, RewriterConfig},
    },
    operation::Operation,
    region::Region,
    r#type::TypeHandle,
...
pub struct PyRewriter {
    obj: Py<PyAny>,
    /// Rewriter configuration, held on the Rust side: the Python rewriter
    /// protocol has no notion of it, and `Rewriter::get_config` must return a
    /// reference.
